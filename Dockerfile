...
RUN curl -O https://www.apache.org/dist/tomcat/tomcat-8/v8.5.40/bin/apache-tomcat-8.5.40.tar.gz && \
	tar -xvf /tmp/apache-tomcat-8.5.40.tar.gz -C /opt/tomcat --strip-components=1 && \
